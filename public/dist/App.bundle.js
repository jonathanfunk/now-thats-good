...
function autocomplete(input, latInput, lngInput) {
  ...
  input.on('keydown', function (e) {
    if (e.keyCode === 13) e.preventDefaut();
  });
}
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 49.28;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -123.12;
